...
normal o
endfunc 
autocmd bufnewfile *.py call PyTitle()


func PHPTitle()
call setline(1, "\"\"\"")
call setline(2, "\# @Author : Hale Lv")
...
normal o
endfunc 
autocmd bufnewfile *.php call PyTitle()
...
normal o
endfunc 
autocmd bufnewfile *.go call PyTitle()
...
normal o
endfunc 
autocmd bufnewfile *.md call PyTitle()
